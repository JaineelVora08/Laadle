...
class QueryOrchestrator:
    ...
    def handle_senior_faq_response(self, senior_id: str, query_id: str,
        ...
        # Build ranked advice list (sorted by trust_score DESC)
        ranked_advice = sorted(advice_list, key=lambda a: a['trust_score'], reverse=True)
