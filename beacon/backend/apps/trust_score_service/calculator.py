...
class TrustScoreCalculator:
    ...
    Formula weights: feedback=0.20, follow_through=0.20, consistency=0.20,
                     alignment=0.20, achievement=0.20
    """
    ...
    def _update_consistency(
        ...
        if reply_time_hours < 2:
            gamma_reply = 5.0
        elif reply_time_hours < 5:
            gamma_reply = 4.0
        elif reply_time_hours < 12:
            gamma_reply = 3.0
        elif reply_time_hours < 24:
            gamma_reply = 2.0
        else:
            gamma_reply = 1.0
